  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3 pointer-events-none">
      ...
      <Link 
        ...
        className="pointer-events-auto flex items-center gap-2 bg-gradient-to-r from-gold-500 to-gold-600 hover:from-gold-600 hover:to-gold-700 text-navy-950 font-bold px-5 py-3 rounded-full shadow-2xl transition-all duration-300 hover:-translate-y-1 group active:scale-95 cursor-pointer"
      >
        ...
        <span className="text-xs md:text-sm tracking-wider uppercase">Apply Now 2026</span>
      ...
      <div className="flex gap-3 pointer-events-auto">
        ...
        <a 
          ...
          className="w-12 h-12 bg-navy-700 hover:bg-navy-800 text-white rounded-full flex items-center justify-center shadow-lg transition-all duration-300 hover:scale-110 cursor-pointer border border-navy-600"
        >
        ...
        <a 
          ...
          className="w-12 h-12 flex items-center justify-center shadow-lg transition-all duration-300 hover:scale-110 cursor-pointer rounded-full overflow-hidden"
        >
          <img 
